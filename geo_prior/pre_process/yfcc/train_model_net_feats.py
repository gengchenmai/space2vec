...
class Params:
    ...
    meta_data = '/media/macaodha/Data/datasets/YFCC100M_GEO100/train_test_split.csv'
    data_root = '/media/macaodha/Data/datasets/YFCC100M_GEO100/images/'
    split_name = 'test'
    ...
    if use_alexnet:
        im_size_crop = 224
        im_size_resize = 256
        model_path = '/media/macaodha/Data/datasets/YFCC100M_GEO100/models_alexnet/'
        features_path = '/media/macaodha/Data/datasets/YFCC100M_GEO100/features_alexnet/'
    else:
        im_size_crop = 299
        im_size_resize = 342
        model_path = '/media/macaodha/Data/datasets/YFCC100M_GEO100/models_inception/'
        features_path = '/media/macaodha/Data/datasets/YFCC100M_GEO100/features_inception/'
    ...
    if evaluate == True:
        ...
        op_file_name = features_path + 'YFCC_' + split_name + '_net_feats'

    best_prec1 = 0.0  # store current best top 5
...
def main():
    ...
    # data loading code
    train_dataset = YFCC_loader.YFCC(args.data_root, args.meta_data,
                     split_name='train', im_size_crop=args.im_size_crop,
                     im_size_resize=args.im_size_resize, is_train=True)
    val_dataset = YFCC_loader.YFCC(args.data_root, args.meta_data,
