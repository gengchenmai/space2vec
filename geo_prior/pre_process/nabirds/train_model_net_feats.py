...
class Params:
    ...
    num_classes = 555
    meta_data = '/media/macaodha/Data/datasets/nabirds/nabirds_with_loc_2019.json'
    data_root = '/media/macaodha/Data/datasets/nabirds/images/'
    split_name = 'val'
    ...
    if use_alexnet:
        im_size_crop = 224
        im_size_resize = 256
        model_path = '/media/macaodha/Data/datasets/nabirds/models/alexnet/'
        features_path = '/media/macaodha/Data/datasets/nabirds/models/alexnet/'
    else:
        im_size_crop = 299
        im_size_resize = 342
        model_path = '/media/macaodha/Data/datasets/nabirds/models/inception/'
        features_path = '/media/macaodha/Data/datasets/nabirds/models/inception/'
    ...
    if evaluate == True:
        ...
        op_file_name = features_path + 'nabirds_' + split_name + '_net_feats'
...
def main():
    ...
    # data loading code
    train_dataset = nabirds_loader.NABirds(args.data_root, args.meta_data,
                     split_name='train', im_size_crop=args.im_size_crop,
                     im_size_resize=args.im_size_resize, is_train=True)
    val_dataset = nabirds_loader.NABirds(args.data_root, args.meta_data,
